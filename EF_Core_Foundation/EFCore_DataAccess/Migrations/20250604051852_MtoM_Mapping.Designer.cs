...
namespace EFCore_DataAccess.Migrations
{
    ...
    [Migration("20250604051852_MtoM_Mapping")]
    partial class MtoM_Mapping
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EFCore_Model.Models.BookAuthorMap", b =>
                {
                    b.Property<int>("Author_Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EFCore_Model.Models.Fluent_Publisher", b =>
                {
                    b.Property<int>("Publisher_Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EFCore_Model.Models.BookAuthorMap", b =>
                {
                    b.HasOne("EFCore_Model.Models.Author", "Author")
            ...
            modelBuilder.Entity("EFCore_Model.Models.Fluent_Book", b =>
                {
                    b.HasOne("EFCore_Model.Models.Fluent_Publisher", "Fluent_Publisher")
            ...
            modelBuilder.Entity("EFCore_Model.Models.Fluent_BookDetail", b =>
                {
                    b.HasOne("EFCore_Model.Models.Fluent_Book", "Fluent_Book")
                        .WithOne("BookDetail")
                        .HasForeignKey("EFCore_Model.Models.Fluent_BookDetail", "Book_Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
